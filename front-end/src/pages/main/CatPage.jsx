    ...
    <div className="flex justify-center items-center h-screen">
      ...
      >
        <g filter="url(#filter0_d_230_2444)">
          <path
            d="M8.23256 5.44186H25.1628V20.5581H8.23256V5.44186Z"
            fill="white"
          />
          <path
        ...
        <defs>
          ...
          >
            ...
            <feblend
              ...
              result="effect1_dropShadow_230_2444"
            />
            <feblend
              mode="normal"
              in="SourceGraphic"
      ...
      <div className="w-[390px] h-[34px] absolute left-0 top-[810px] bg-white"></div>
    </div>
  );
};
