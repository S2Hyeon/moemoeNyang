  ...
  return (
    <div>
      {inputVisible ? (
        ...
        <button style={{ boxShadow: "0px 4px 4px 0 rgba(0,0,0,0.25)" }} class="rounded-full w-[335px] h-[41.79px] bg-[#f1ebeb] px-5 py-3 text-base mb-3 font-medium text-black transition duration-200 active:bg-[#e2d5d5]" onClick={handleClick}>{setName || "이름"}</button>
      )}
    </div>
  );
}
